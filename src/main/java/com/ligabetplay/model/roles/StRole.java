...
import com.ligabetplay.view.viewSt;

/* -------------------------------------------------------*/
public class StRole implements Role {
    private int id;
    private String rol;
    ...
    public void accessMenu() {
        ...
        viewSt.showMenu(lstPermits);
    }
    public StRole(int id, String rol, List<Permiso> lstPermits) {
        this.id = id;
        this.rol = rol;
