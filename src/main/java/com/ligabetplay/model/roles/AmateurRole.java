...
import com.ligabetplay.view.viewAmateur;

public class AmateurRole implements Role {
    private int id;
    private String rol;
    ...
    public void accessMenu() {
        viewAmateur.showMenu(lstPermits);
    }
    public AmateurRole(int id, String rol, List<Permiso> lstPermits) {
        this.id = id;
        this.rol = rol;
